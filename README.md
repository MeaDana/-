...
В результате работы показано, что выбор алгоритма зависит от свойств графа:  
при неотрицательных весах оптимальным решением является применение **алгоритма Дейкстры**.
